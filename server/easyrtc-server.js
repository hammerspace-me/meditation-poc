...
easyrtc.listen(app, socketServer, null, (err, rtcRef) => {
  ...
  rtcRef.events.on("easyrtcMsg", (param1, param2, param3) => {
    console.log("Msg received" + param1.getEasyrtcid());
    console.log("message" + JSON.stringify(param2, null, 2));
    easyrtc.events.defaultListeners.easyrtcMsg(param1, param2, param3);
  });
});
